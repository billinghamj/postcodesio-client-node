...
PostcodesIO.prototype.near = function (arg1, arg2, arg3) {
	...
	*/
	...
	if (typeof arg1 === 'number' && typeof arg2 === 'number')
		return this.nearCoordinate(arg1, arg2, arg3);
...
PostcodesIO.prototype.nearCoordinate = function (latitude, longitude, callback) {
	var lat = qs.escape(latitude);
	var lon = qs.escape(longitude);

	return this
		._request('get', 'postcodes/lat/' + lat + '/lon/' + lon)
		.then(function (data) {
